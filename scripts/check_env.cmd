...
python --version
echo.
echo Testing import sre using the same Python shown by "where python" / "python --version" ^(must match dev_server^)...
python -c "import sre, sys; import sre.api.app; print('OK: sre import works'); print('OK: executable =', sys.executable)" 2>&1
if errorlevel 1 (
  echo.
  ...
  echo   Or:   python -m uvicorn sre.api.app:create_app --factory --host 127.0.0.1 --port 8042
