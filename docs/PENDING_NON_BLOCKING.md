...
|----------|------|------------------------|
| Code | **Native Cython/Rust hot loop** | The `sparkrules_native` namespace is reserved; a full implementation is a separate multi-week effort. Bridge / PyO3 template: [`examples/native/`](../examples/native/README.md). |
