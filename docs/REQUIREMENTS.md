...
detail (beyond the mermaid below) is not maintained as a separate `design.md` in this repository snapshot; these diagrams are provided so each requirement can
