...
## 8. Related stakeholder deliverables (repo root)

PM / field / security reviewers may start here; this document remains **normative** for Req 1–37.

| File | Contents |
|------|-----------|
| [SPARKRULES_BUG_REPORT.md](../SPARKRULES_BUG_REPORT.md) | 23-item bug register with forensics and status |
| [BENCHMARK_3WAY.md](../BENCHMARK_3WAY.md) | SparkRules vs Drools vs Python pack positioning |
| [BENCHMARK_LATENCY.md](../BENCHMARK_LATENCY.md) | Single-fact latency summary |
| [RULE_ENGINE_COMPARISON.md](../RULE_ENGINE_COMPARISON.md) | Thirteen-engine matrix |
| [DESIGN_REVIEW.md](../DESIGN_REVIEW.md) | Legacy Spark V1 path limitations |
| [DESIGN_OPTIMAL.md](../DESIGN_OPTIMAL.md) | Rules-as-DataFrame blueprint |
| [OPTIMIZED_BENCHMARK.md](../OPTIMIZED_BENCHMARK.md) | Harness / prototype benchmark pointers |
| [dbt_mapping_sheet.md](../dbt_mapping_sheet.md) | dbt clinical example end-to-end mapping |
